    ...
    <section className="py-8 sm:py-16 min-h-screen bg-main">
      <div className="container max-w-5xl mx-auto px-4 sm:px-6">
        {displayMode === 'advanced' && (
          <div className="bg-surface rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 border border-border-secondary/50 shadow-sm">
            {/* Mobile Controls */}
            <div className="block sm:hidden space-y-4">
              {/* Search Bar - Keep at top for easy access */}
              <div className="relative">
                <input
                  ...
                  className="w-full bg-content text-text-primary rounded-lg px-10 py-3 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent/50 text-right text-sm border border-border-secondary/50 transition-all duration-200"
                  dir="rtl"
                />
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute left-3 top-1/2 -translate-y-1/2 text-text-muted hover:text-text-primary p-1 rounded-md hover:bg-elevated transition-colors duration-200"
                  >
              ...
              {/* Display Mode Controls - Most important setting */}
              <div className="flex items-center justify-center">
                <div className="flex items-center gap-2 bg-content rounded-lg p-1 border border-border-secondary/50">
                  <button
                    onClick={() => changeDisplayMode('basic')}
                    className="px-4 py-2 rounded-lg text-xs font-medium transition-all duration-200 bg-content text-text-muted hover:text-text-primary hover:bg-elevated"
                  >
                    بسيط
                  </button>
                  <button
                    onClick={() => changeDisplayMode('advanced')}
                    className="px-4 py-2 rounded-lg text-xs font-medium transition-all duration-200 bg-accent text-[var(--color-badge-text)] shadow-sm"
                  >
                    متقدم
                  </button>
                </div>
              ...
              {/* Reading Controls - Font size and type grouped together */}
              <div className="bg-content rounded-lg p-3 border border-border-secondary/50">
                <div className="text-xs text-text-muted mb-3 text-center">إعدادات القراءة</div>
                <div className="space-y-3">
                  {/* Font Size Controls */}
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-text-secondary">حجم الخط</span>
                    <div className="flex items-center gap-2">
                      <button
                        onClick={decreaseFontSize}
                        className="theme-button-mobile w-8 h-8"
                        title="تصغير الخط"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div className="theme-button-mobile w-12 h-8 flex items-center justify-center font-medium text-xs">
                        {fontSizeLevel}
                      </div>
                      <button
                  ...
                  {/* Font Type Controls */}
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-text-secondary">نوع الخط</span>
                    <div className="font-dropdown-mobile">
                      <button
                        onClick={() => setIsFontDropdownMobileOpen(!isFontDropdownMobileOpen)}
                        className="font-dropdown-button-mobile min-w-[80px]"
                      >
                        <span className="text-xs">{getFontDisplayName(currentFont)}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-3 w-3 transition-transform duration-200 ${isFontDropdownMobileOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Theme Controls - Visual preference */}
              <div className="bg-content rounded-lg p-3 border border-border-secondary/50">
                <div className="text-xs text-text-muted mb-3 text-center">المظهر</div>
                <div className="flex items-center justify-center gap-2">
                  <button
                    onClick={() => changeTheme('dark')}
                    className={`theme-button-mobile flex-1 ${currentTheme === 'dark' ? 'active' : ''}`}
                    title="المظهر المظلم"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <button
                    ...
                    className={`theme-button-mobile flex-1 ${currentTheme === 'light' ? 'active' : ''}`}
                    title="المظهر الفاتح"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <button
                    ...
                    className={`theme-button-mobile flex-1 ${currentTheme === 'sepia' ? 'active' : ''}`}
                    title="المظهر الدافئ"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="hidden sm:flex items-center justify-between gap-6">
              {/* Search Bar */}
              <div className="flex-1 max-w-[400px] min-w-[250px] transition-all duration-300">
                <div className="relative">
                  <input
                    type="text"
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    placeholder="ابحث في الآيات..."
                    className="w-full bg-content text-text-primary rounded-lg px-10 py-2.5 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent/50 text-right border border-border-secondary/50 transition-all duration-200"
                    dir="rtl"
                  />
                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-text-muted">
              ...
              <div className="flex items-center gap-3 border-r border-border-primary pr-6">
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => changeDisplayMode('basic')}
                    className="px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 bg-content text-text-muted hover:text-text-primary hover:bg-elevated border border-border-secondary/50"
                  >
                    بسيط
                  </button>
                  <button
                    onClick={() => changeDisplayMode('advanced')}
                    className="px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 bg-accent text-[var(--color-badge-text)] shadow-sm"
                  >
                    متقدم
                  </button>
                </div>
              ...
              <div className="flex items-center gap-3">
                <div className="font-dropdown">
                  ...
                  >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 transition-transform duration-200 ${isFontDropdownOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
                  </button>
                  {isFontDropdownOpen && (
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => changeDisplayMode('basic')}
                    className="px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 bg-accent text-[var(--color-badge-text)] shadow-sm"
                  >
                    بسيط
                  </button>
                  <button
                    onClick={() => changeDisplayMode('advanced')}
                    className="px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 bg-content text-text-muted hover:text-text-primary hover:bg-elevated border border-border-secondary/50"
                  >
                    متقدم
                  </button>
                </div>
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={decreaseFontSize}
                    className="theme-button-mobile sm:theme-button"
                    title="تصغير الخط"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4" />
                  ...
                  <div className="theme-button-mobile sm:theme-button flex items-center justify-center font-medium text-xs sm:text-sm">
                    {fontSizeLevel}
                  </div>
                  <button
                    onClick={increaseFontSize}
                ...
                <div className="font-dropdown">
                  <button
                    ...
                    className="font-dropdown-button"
                  >
                    <span className="text-xs sm:text-sm">{getFontDisplayName(currentFont)}</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className={`h-3 w-3 transition-transform duration-200 ${isFontDropdownOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
                  </button>
                  {isFontDropdownOpen && (
        ...
        {displayMode === 'advanced' && searchQuery && (
          <div className="bg-surface/50 rounded-lg py-3 px-4 sm:px-6 mb-6 sm:mb-8 text-right border border-border-secondary/30 backdrop-blur-sm">
          ...
          {filteredVerses.map((verse, index) => (
            <div 
              ...
              className={`verse-card p-4 sm:p-8 fade-in ${
                displayMode === 'advanced' && verse.numberInSurah !== 0 ? 'cursor-pointer' : ''
              } ${
                selectedVerse === verse.numberInSurah ? 'selected' : ''
              }`}
              style={{ animationDelay: `${Math.min(index * 0.01, 0.5)}s` }}
              onClick={() => {
                if (displayMode === 'advanced' && verse.numberInSurah !== 0) {
            ...
            >
              ...
              {displayMode === 'advanced' && audioState.currentVerse === verse.numberInSurah && verse.numberInSurah !== 0 && (
              ...
              {displayMode === 'advanced' && selectedVerse === verse.numberInSurah && (
